from Doa.definitions import InsertIntoTask, UpdatePriority, UpdateNotes, UpdateBookmark, UpdateStatus, InsertIntoUser, AllTasksUser, TasksBasedOnStatus, AllTasks ,AssignTask, SendEmail
from Doa.user_task_classes import ForTask, ForUser

func = input(""" Select one:
           1.InsertIntoUser
           2.InsertIntoTask
           3.UpdatePriority
           4.UpdateNotes
